...
You can add any function you want depending on how many devices you have attached.
For example you could have a function called 'fun' which would dim the lights and
